...
(println "byr:2002" (birth-year? "2002"))
(println "byr:2003" (birth-year? "2003"))
(println "hgt:60in" (height? "60in"))
(println "hgt:190in" (height? "190in"))
(println "hcl:#123abc" (hair-color? "#123abc"))
(println "hcl:#123abz" (hair-color? "#123abz"))
...
(println (count (filter valid-passport? (lines->map input-4))))
